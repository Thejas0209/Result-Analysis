...
def plotStudentAnalysis(usn_no, mark_sheet_df, question_paper_df):
    '''
    plot_student_analysis(usn_no, mark_sheet_df, qp_df):
    input : usn_number , marks sheet dataframe , qp_df
    output : buffer image containing 4 subplots 2 bar graph and 2 pie charts
    '''
    # Get CO and CD data for the student
    cognitive_domain, course_outcome, cognitive_domain_total_marks, course_outcome_total_marks = DataAnalyizer.cognitiveDomainCourseOutcomeAnalysis(mark_sheet_df, question_paper_df)
