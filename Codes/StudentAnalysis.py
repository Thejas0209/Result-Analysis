...
def plotStudentAnalysis(usn_no, qp_mark_sheet_df, marks_schema):
    '''
    ...
    cognitive_domain, course_outcome, cognitive_domain_total_marks, course_outcome_total_marks = DataAnalyizer.cognitiveDomainCourseOutcomeAnalysis(qp_mark_sheet_df, marks_schema)
